...
$db['whowentout']['hostname'] = 'db01-share';
$db['whowentout']['username'] = 'CodeIgniter-8910';
$db['whowentout']['password'] = 'MySQL4668';
$db['whowentout']['database'] = 'whowentout-com';
$db['whowentout']['dbdriver'] = 'mysql';
$db['whowentout']['dbprefix'] = '';
$db['whowentout']['pconnect'] = TRUE;
$db['whowentout']['db_debug'] = TRUE;
$db['whowentout']['cache_on'] = FALSE;
$db['whowentout']['cachedir'] = '';
$db['whowentout']['char_set'] = 'utf8';
$db['whowentout']['dbcollat'] = 'utf8_general_ci';
$db['whowentout']['swap_pre'] = '';
$db['whowentout']['autoinit'] = TRUE;
$db['whowentout']['stricton'] = FALSE;

$db['whowasout']['hostname'] = 'db01-share';
$db['whowasout']['username'] = 'CodeIgnite-13568';
$db['whowasout']['password'] = 'MySQL4668';
$db['whowasout']['database'] = 'whowasout-com';
