...
class Clock_Tests extends TestGroup
{
    ...
    function test_clock_basic()
    {
        ...
        $clock->set( new DateTime('2011-10-20 09:30:00') );

        $this->assert_equal($clock->get()->format('Y-m-d H:i:s'), '2011-10-20 09:30:00');
    }
    ...
    function test_clock_current_time()
    {
        ...
        $this->assert_equal($clock->get()->format('Y-m-d H:i:s'), $current_time->format('Y-m-d H:i:s'));
    }
