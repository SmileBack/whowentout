...
$wwo = array();
$wwo['currentTime'] = college()->get_clock()->get_time()->getTimestamp();
...
$wwo['yesterdayTime'] = college()->get_clock()->get_time()->getDay(-1)->getTimestamp();
$wwo['tomorrowTime'] = college()->get_clock()->get_time()->getDay(+1)->getTimestamp();
