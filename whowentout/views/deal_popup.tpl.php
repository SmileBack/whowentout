<form class="deal_popup" method="post" action="/events/deal_confirm">
    ...
    <h4><span style="font-size: 20px;">&darr;</span> Show this to the bartender <span style="font-size: 20px;">&darr;</span></h4>
    <input type="hidden" name="event_id" value="<?= $event->id ?>" />

    <img alt="sample deal" src="/images/deal_popup.png?version=2"/>
