...
(function($) {
    ...
    $.fn.replaceWithDetached = function( value ) {
		if ( this[0] && this[0].parentNode ) {
			...
			if ( jQuery.isFunction( value ) ) {
				return this.each(function(i) {
					...
					self.replaceWithDetached( value.call( this, i, old ) );
				});
			}
			...
			return this.length ?
				this.pushStack( jQuery(jQuery.isFunction(value) ? value() : value), "replaceWithDetached", value ) :
				this;
		}
	};
